...
24/7 generative VCL runtime. Kuramoto criticality substrate. OpenAI-compatible gateway.

Gateway authentication is supplied at runtime with OPENCLAW_GATEWAY_TOKEN. No gateway secret is stored in this repository.

## Endpoints
- GET / — VCL visualizer (real-time Kuramoto criticality)
- GET /health — system state + experimental Φ proxy
